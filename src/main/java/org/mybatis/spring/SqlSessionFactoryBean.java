...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
	...
	public void setMybatisRefreshProperties(MybatisRefreshProperties mybatisRefreshProperties) {
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		LOGGER.debug("系统刷新mybatis的状态为:"+this.mybatisRefreshProperties.toString());
		new org.apache.ibatis.thread.Runnable(location, configuration, this.mybatisRefreshProperties).run();
